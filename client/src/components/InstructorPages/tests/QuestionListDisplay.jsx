...
function QuestionListDisplay({questions, onRemove}) {
    return (<div className={"border border-gray-50 shadow-lg rounded-lg p-3"}>
            <List
                ...
                renderItem={(item, index) => (<List.Item
                    ...
                    >
                        ...
                        />
                        {item.options && item.options.length > 0 && (<div>
                                <strong>Options:</strong>
                                <ul>
                                    {item.options.map((option, optIndex) => (<li key={optIndex}>
